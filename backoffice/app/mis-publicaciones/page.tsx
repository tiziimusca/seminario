...
export default function MisPublicacionesPage() {
  ...
  const { data: propuestas, loading, error, refetch } = useApi(() => api.propuestas.getAll())
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {propuestas?.length === 0 && <div className="text-center text-gray-500 py-8">No tienes publicaciones</div>}
      </div>
    </Layout>
  )
}

...
class CalificacionViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        ...
        description="Devuelve una lista de todas las calificaciones.",
        responses={
    ...
    @extend_schema(
        ...
        description="Devuelve una calificacion por ID.",
        responses={200: CalificacionSerializer, 401: unauthorized_response, 404: {
            "description": "No encontrado"}}
    )
    ...
    @extend_schema(
        ...
        request=CalificacionSerializer,
        responses={
    ...
    @extend_schema(
        summary="Actualiza una calificacion",
        description="Reemplaza completamente una calificacion existente por ID.",
        request=CalificacionSerializer,
        responses={
    ...
    @extend_schema(
        ...
        description="Modifica solo algunos campos de una calificacion existente.",
        request=CalificacionSerializer,
        responses={
            200: CalificacionSerializer,
            400: bad_request_response,

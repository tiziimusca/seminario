...
class ClaseFilter(django_filters.FilterSet):
    ...
    owenId = CharFilter(field_name='owenId', lookup_expr='icontains')
    ...
    duration = django_filters.DurationFilter(field_name='duration', lookup_expr='gte')

    class Meta:
        model = Clase
        fields = [
            'title', 'tema', 'guestId', 'owenId', 'date', 'price', 'duration'
        ]
...
class UserFilter(django_filters.FilterSet):
    ...
    horary = django_filters.CharFilter(field_name='horary', lookup_expr='icontains')
...
class PropuestaFilter(django_filters.FilterSet):
    ...
    tema = CharFilter(field_name='tema', lookup_expr='icontains')
    description = CharFilter(field_name='description', lookup_expr='icontains')
    initial_price = django_filters.NumberFilter(field_name='initial_price', lookup_expr='gte')
    state = CharFilter(field_name='state', lookup_expr='icontains')
    date_available = django_filters.DateTimeFilter(field_name='date_available', lookup_expr='gte')
